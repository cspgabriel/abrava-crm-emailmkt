    ...
    <div className="relative space-y-5 pt-28 pb-20 px-3 sm:px-6 max-w-7xl mx-auto">
      ...
      <div className="flex flex-col gap-4">
        <div className="space-y-2 mb-4">
          ...
          <p className="text-[var(--brand-ivory)]/70 font-medium text-sm sm:text-base">Veja credito, parcela e prazo antes do cadastro. A entrada fica liberada no acesso completo.</p>
          <div className="pt-2">
            <span className="inline-flex items-center gap-2 px-4 py-1.5 bg-[var(--brand-gold)]/20 border border-[var(--brand-gold)]/40 text-[var(--brand-gold-soft)] rounded-xl text-xs sm:text-sm font-black uppercase tracking-widest shadow-lg">
              ...
              {filteredLetters.length} {filteredLetters.length === 1 ? 'Carta Contemplada' : 'Cartas Contempladas'}
            </span>
          </div>
        </div>
          ...
          >
            ...
            <div className="relative z-10">
              ...
              <div className="grid grid-cols-2 gap-y-1.5 gap-x-1.5 mb-2.5">
                ...
                <div className="bg-black/20 p-2 rounded-xl border border-white/5">
                  <p className="text-[9px] text-white/50 uppercase font-black tracking-widest mb-0.5">Acesso Completo</p>
                  <div className="font-black text-[var(--brand-gold-soft)] text-xs">
                    <button onClick={(e) => { e.stopPropagation(); handleOpenFicha(letter); }} className="text-[8px] font-black border border-[var(--brand-gold)]/40 hover:border-[var(--brand-gold)] text-[var(--brand-gold-soft)] px-2 py-0.5 rounded-full transition-colors mt-0.5">VER ENTRADA</button>
                  </div>
                </div>
                <div className="bg-black/20 p-2 rounded-xl border border-white/5">
