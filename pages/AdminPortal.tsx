...
const AdminPortal: React.FC = () => {
  ...
  const [dashFilterLetterMinCredit, setDashFilterLetterMinCredit] = useState('');
  const [dashFilterLetterMaxCredit, setDashFilterLetterMaxCredit] = useState('');
  const [dashFilterLetterMinParcel, setDashFilterLetterMinParcel] = useState('');
  const [dashFilterLetterMaxParcel, setDashFilterLetterMaxParcel] = useState('');
  const [dashFilterLetterAdmin, setDashFilterLetterAdmin] = useState('');
  const [dashFilterLetterMinParcelas, setDashFilterLetterMinParcelas] = useState('');
  const [dashFilterLetterMaxParcelas, setDashFilterLetterMaxParcelas] = useState('');
  ...
  const clearDashFilters = () => {
    ...
    setDashFilterLetterMinCredit('');
    setDashFilterLetterMaxCredit('');
    setDashFilterLetterMinParcel('');
    setDashFilterLetterMaxParcel('');
    setDashFilterLetterAdmin('');
    setDashFilterLetterMinParcelas('');
    setDashFilterLetterMaxParcelas('');
  ...
  const dashLetters = letters.filter(l => {
    ...
    if (dashFilterLetterAdmin && !(l.administrator || '').toLowerCase().includes(dashFilterLetterAdmin.toLowerCase())) return false;
    if (dashFilterLetterMinCredit && (l.credit ?? 0) < Number(dashFilterLetterMinCredit)) return false;
    if (dashFilterLetterMaxCredit && (l.credit ?? 0) > Number(dashFilterLetterMaxCredit)) return false;
    if (dashFilterLetterMinParcel && (l.installmentValue ?? 0) < Number(dashFilterLetterMinParcel)) return false;
    if (dashFilterLetterMaxParcel && (l.installmentValue ?? 0) > Number(dashFilterLetterMaxParcel)) return false;
    if (dashFilterLetterMinParcelas && (l.installmentsCount ?? 0) < Number(dashFilterLetterMinParcelas)) return false;
    if (dashFilterLetterMaxParcelas && (l.installmentsCount ?? 0) > Number(dashFilterLetterMaxParcelas)) return false;
    return true;
  ...
  const activeFilterCount =
    ...
    (dashFilterLetterAdmin ? 1 : 0) +
    (dashFilterLetterMinCredit ? 1 : 0) +
    (dashFilterLetterMaxCredit ? 1 : 0) +
    (dashFilterLetterMinParcel ? 1 : 0) +
    (dashFilterLetterMaxParcel ? 1 : 0) +
    (dashFilterLetterMinParcelas ? 1 : 0) +
    (dashFilterLetterMaxParcelas ? 1 : 0);
            ...
            {showDashFilters && (
              ...
              <div className="px-6 pb-6 border-t border-slate-100 pt-5 space-y-5">
                ...
                <div>
                  ...
                  <p className="text-[10px] font-black text-slate-400 uppercase tracking-widest mb-2">Valor Total (Crédito)</p>

                  <div className="grid grid-cols-2 gap-2">

                    <div>

                      <label className="text-[9px] font-black text-slate-400 uppercase tracking-widest block mb-1">Mínimo</label>
                      ...
                      <input
                        ...
                        value={dashFilterLetterMinCredit}

                        onChange={e => setDashFilterLetterMinCredit(e.target.value)}
                    ...
                    <div>
                      ...
                      <label className="text-[9px] font-black text-slate-400 uppercase tracking-widest block mb-1">Máximo</label>
                      ...
                      <input
                        ...
                        value={dashFilterLetterMaxCredit}

                        onChange={e => setDashFilterLetterMaxCredit(e.target.value)}
                ...
                <div>
                  ...
                  <p className="text-[10px] font-black text-slate-400 uppercase tracking-widest mb-2">Valor da Parcela</p>
                  ...
                  <div className="grid grid-cols-2 gap-2">
                    ...
                    <div>
                      ...
                      <input
                        ...
                        value={dashFilterLetterMinParcel}

                        onChange={e => setDashFilterLetterMinParcel(e.target.value)}
                    ...
                    <div>
                      ...
                      <input
                        ...
                        value={dashFilterLetterMaxParcel}

                        onChange={e => setDashFilterLetterMaxParcel(e.target.value)}
                ...
                <div>
                  ...
                  <p className="text-[10px] font-black text-slate-400 uppercase tracking-widest mb-2">Administradora</p>
                  ...
                  <div className="relative">
                    ...
                    <input
                      ...
                      value={dashFilterLetterAdmin}

                      onChange={e => setDashFilterLetterAdmin(e.target.value)}
                  ...
                  <div className="grid grid-cols-2 gap-2">
                    ...
                    <div>
                      ...
                      <input
                        ...
                        value={dashFilterLetterMinParcelas}

                        onChange={e => setDashFilterLetterMinParcelas(e.target.value)}
                    ...
                    <div>
                      ...
                      <input
                        ...
                        value={dashFilterLetterMaxParcelas}

                        onChange={e => setDashFilterLetterMaxParcelas(e.target.value)}
              ...
              <table className="w-full text-left">
                ...
                <thead>
                  ...
                  <tr className="bg-slate-50 border-b border-slate-200 text-slate-400 text-[10px] uppercase tracking-[0.2em] font-black">
                    ...
                    <th className="px-6 py-5">Última interação</th>
