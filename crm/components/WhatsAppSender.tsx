              ...
              {!whatsappReady && connectionState !== 'initializing' && (
                <div className="space-y-2">
                  ...
                  <div className="bg-blue-50 border border-blue-200 rounded p-2 text-xs text-blue-700">
                    ðŸ’¡ <strong>Dica:</strong> Se escaneou o QR, aguarde 2-3 segundos para a conexão ser estabelecida.
                  </div>
                </div>
              )}
        </div>
      ...
      <div className="w-full mt-6">
        <div className="bg-white border border-gray-200 rounded-xl p-5 shadow-sm">
          <div className="flex items-center justify-between gap-3 mb-4">
            ...
            <button onClick={() => saveHistoryItems([])} className="text-xs text-red-600 hover:underline font-medium">ðŸ—‘ï¸ Limpar histórico</button>
          </div>
          ...
          <div className="bg-white rounded-xl max-w-3xl w-full max-h-[80vh] overflow-y-auto shadow-2xl">
            ...
            <div className="p-6 space-y-6">
              <div className="bg-blue-50 border-l-4 border-blue-500 p-4">
                ...
                <p className="text-xs text-blue-700">ðŸ’¡ Respeite esses limites. Se ultrapassar, seu número pode ser bloqueado temporariamente para proteção contra abuso.</p>
              </div>
              ...
              <div className="bg-orange-50 border-l-4 border-orange-500 p-4">
                ...
                <p className="text-xs text-orange-700">ðŸŽ¯ Geralmente leva ~1-3 meses para chegar aqui. Agora você pode usar o WhatsApp de forma mais intensa.</p>
              </div>
              ...
              <div className="bg-red-50 border-l-4 border-red-500 p-4">
                ...
                <p className="text-xs text-red-700">ðŸš€ Requer ~6+ meses com uso contínuo. Raríssimo sofrer bloqueios neste estágio.</p>
              </div>
