...
const emptyTemplate = {
  ...
  <h1 style="margin:0 0 16px;">Ol�, {{name}}!</h1>
  <p style="margin:0 0 12px;">Escreva aqui o conte�do principal da sua campanha.</p>
...
export const EmailMarketingWorkspace: React.FC<{ contacts?: any[]; campaigns?: any[] }> = ({
  ...
  const handleCreateHistory = async () => {
    ...
    showFeedback('Campanha registrada no hist�rico.');
  };
        ...
        <div className="flex flex-col gap-5 lg:flex-row lg:items-center lg:justify-between">
          <div className="space-y-2">
            <div className="inline-flex items-center gap-2 rounded-full bg-blue-50 px-3 py-1 text-xs font-semibold text-blue-700">
              ...
              Novo m�dulo isolado do CRM atual
            </div>
            <h1 className="text-3xl font-bold text-slate-900">E-mail Marketing Pro</h1>
            <p className="max-w-3xl text-sm text-slate-600">
              Expans�o segura com p�ginas novas para listas, designer de email e hist�rico de campanhas,
              sem alterar a tela atual de envio que j� est� funcionando.
            </p>
          </div>
        ...
        <div className="grid gap-6 xl:grid-cols-[1.15fr_0.85fr]">
          <div className="rounded-3xl border border-slate-200 bg-white p-6 shadow-sm">
            <div className="mb-4 flex items-center justify-between gap-3">
              <div>
                <h2 className="text-xl font-bold text-slate-900">Listas de distribui��o</h2>
            ...
            <div className="grid gap-4 md:grid-cols-2">
              ...
              <input value={listTags} onChange={(e) => setListTags(e.target.value)} placeholder="Tags (VIP, Hot�is, Eventos)" className="rounded-2xl border border-slate-200 px-4 py-3 text-sm outline-none focus:border-blue-400" />
            </div>
            <textarea value={listDescription} onChange={(e) => setListDescription(e.target.value)} placeholder="Descri��o da estrat�gia ou crit�rio da lista" rows={3} className="mt-4 w-full rounded-2xl border border-slate-200 px-4 py-3 text-sm outline-none focus:border-blue-400" />
          ...
          <div className="space-y-6">
                  ...
                  <div key={item.id} className="rounded-2xl border border-slate-200 p-4">
                    <div className="flex items-start justify-between gap-3">
                      <div>
                        ...
                        <div className="mt-1 text-xs text-slate-500">{item.description || 'Sem descri��o'}</div>
                      </div>
            ...
            <div className="rounded-3xl border border-slate-200 bg-slate-900 p-6 text-white shadow-sm">
              ...
              <ul className="mt-4 space-y-2 text-sm text-slate-200">
                <li>- Usa cole��es novas do Firestore, sem sobrescrever campanhas existentes.</li>
                <li>- Permite preparar segmenta��es antes de ligar o envio real.</li>
                <li>- Reaproveita sua base de contatos j� cadastrada no CRM.</li>
              </ul>
            </div>
          </div>
        </div>
        ...
        <div className="grid gap-6 xl:grid-cols-[0.9fr_1.1fr]">
          ...
          <div className="rounded-3xl border border-slate-200 bg-white p-6 shadow-sm">
            <div className="mb-4 flex items-center gap-2">
              ...
              <h3 className="text-lg font-bold text-slate-900">Pr�-visualiza��o</h3>
            </div>
          ...
          <div className="grid gap-6 xl:grid-cols-[0.72fr_1.28fr]">
            <div className="rounded-3xl border border-slate-200 bg-white p-6 shadow-sm">
              ...
              <p className="mt-2 text-sm text-slate-500">
                Esta tela j� pode organizar o hist�rico, mesmo antes de conectar o disparo autom�tico.
              </p>
            ...
            <div className="rounded-3xl border border-slate-200 bg-white p-6 shadow-sm">
              <div className="flex flex-col gap-4 md:flex-row md:items-center md:justify-between">
                <div>
                  <h2 className="text-xl font-bold text-slate-900">Hist�rico de campanhas</h2>
                  <p className="text-sm text-slate-500">Unifica o hist�rico novo com as campanhas que j� existiam no CRM.</p>
                </div>
                ...
                <table className="w-full min-w-[900px] text-left text-sm">
                  <thead className="bg-slate-50">
                    <tr className="border-b border-slate-200">
                      ...
                      <th className="px-4 py-3 font-semibold text-slate-600">Destinat�rios</th>
